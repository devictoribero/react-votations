...
`react-votations` is an application to vote for proposals at home, in the office or with your team.

The idea is to be able to create questions where the users can vote with thumbs up, thumbs down or neutral.

One feature I like is even in teams or friends should be transparency.. I want to make possible

to vote anonymously to make people feel more comfortable giving his/her opinion.

After that, I'll like to add multiple answer and different things.

## MVP

It does not read from any database. All is created in run-time by the user.

Everyone can create questions.

Only the user who is running the app can vote (only anonymously)

## MVP2

The app read from any database. So, other users can use the platform and vote too.

## MVP3

The users can vote not only anonymously. People can make their vote visible
